            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
               <div class="kt-grid">
                  <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                     ...
                     <form method="POST" action="{{ route('create_new_sub_coordinator') }}"  class="kt-form" id="kt_apps_user_add_user_form">
                        @csrf
                                          ...
                                          <div class="form-group row">
                                             ...
                                             <div class="col-lg-9 col-xl-9">
                                                <select class="form-control" name="role">
                                                   <option data-offset="-39600" value="4">Main Dealer</option>
                                                   <option data-offset="-39600" value="5">Sub Dealer</option>
