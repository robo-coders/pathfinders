            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
               <div class="kt-grid">
                  <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                     ...
                     <form method="POST" action="{{ route('create_new_user') }}"  class="kt-form" id="kt_apps_user_add_user_form" enctype="multipart/form-data">
                        @csrf
                                          ...
                                          <div class="form-group row">
                                             ...
                                             <div class="col-lg-9 col-xl-9">
                                                <select class="form-control" name="role">
                                                   <option data-offset="-39600" value="2">Coordinator</option>
                                                   <option data-offset="-39600" value="3">Teacher</option>
                                                   <option data-offset="-39600" value="4">Student</option>
                                                </select>
                                             </div>
                                          </div>
                                       </div>
