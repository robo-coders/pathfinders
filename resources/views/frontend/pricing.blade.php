...
@section('body')
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('/assets/frontend/images/2.jpg');">
    	...
    	<div class="container">
        	...
        	<div class="col-md-6 col-lg-3 ftco-animate">
        		<div class="pricing-entry bg-light pb-4 text-center">
	        		...
	        		<div class="img" style="background-image: url(/assets/frontend/images/classes-1.jpg);"></div>
	        		<div class="px-4">
